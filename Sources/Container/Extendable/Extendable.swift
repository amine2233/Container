...
public struct Extend: Codable, ExpressibleByDictionaryLiteral {
    ...
    ///
    public func get<T>(_ key: AnyKeyPath, `default` value: T) -> T {
        return get(key.hashValue.description, default: value)
    }
    ...
    ///
    public func get<T>(_ key: String, `default` value: T) -> T {
